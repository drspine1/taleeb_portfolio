          ...
          <li
           className="w-[90vw] max-w-full relative rounded-2xl border border-b-0
            ...
            <blockquote>
              ...
              <span
                className="relative z-20 text-lg  italic leading-[1.6] font-normal text-[#e4ecff] dark:text-gray-100 ">
                {item.quote}
              </span>
              <div className="relative z-20 mt-6 flex flex-row items-center">
                <span className="flex flex-col gap-1">
                  <span
                    className="text-sm leading-[1.6] font-bold text-[#BEC1DD] ">
                    {item.name}
                  </span>
                  <span
                    className="text-sm leading-[1.6] font-normal text-[#BEC1DD] ">
                    {item.title}
                  </span>
                </span>
              </div>
